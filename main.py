...
def menu():
   ...
   {color_2}[4] {color_6}FakeN         {color_2}[8] {color_6}Flush DNS cache   {color_2}[12] {color_6}Installer
    ...
    {color_5}V1.2 | {color_5}Entry time: {color_4}{clock} {color_5} | [{color_4}100{color_5}]{color_6}Exit
"""
    print(main_menu)
...
def installer():
    ...
    {color_5}V1.2 | {color_5}Entry time: {color_4}{clock} {color_5} | [{color_4}100{color_5}]{color_6}Return                                
    """
        ...
        if user_input == user and password_input == password:
            ...
            match choice:
                ...
                case 12:
                    ...
                    logo_installer()
                    installer()
                    choice_installer = int(input(f'{color_2}> '))
